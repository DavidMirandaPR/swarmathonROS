...
if("TRUE" STREQUAL "TRUE")
  set(ublox_gps_SOURCE_PREFIX /home/interamericana/rover_workspace/src/ublox/ublox_gps)
  set(ublox_gps_DEVEL_PREFIX /home/interamericana/rover_workspace/devel)
  ...
  set(ublox_gps_INSTALL_PREFIX /home/interamericana/rover_workspace/install)
...
if(NOT "/home/interamericana/rover_workspace/src/ublox/ublox_gps/include " STREQUAL " ")
  set(ublox_gps_INCLUDE_DIRS "")
  set(_include_dirs "/home/interamericana/rover_workspace/src/ublox/ublox_gps/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ublox_gps' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/interamericana/rover_workspace/src/ublox/ublox_gps/${idir}'.  Ask the maintainer 'Johannes Meyer <nothing@nobody.com>, Gareth Cross <gcross.code@icloud.com>' to fix it.")
    endif()
