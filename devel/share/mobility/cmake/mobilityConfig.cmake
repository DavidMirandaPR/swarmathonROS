...
if("TRUE" STREQUAL "TRUE")
  set(mobility_SOURCE_PREFIX /home/interamericana/rover_workspace/src/mobility)
  set(mobility_DEVEL_PREFIX /home/interamericana/rover_workspace/devel)
  set(mobility_INSTALL_PREFIX "")
  set(mobility_PREFIX ${mobility_DEVEL_PREFIX})
else()
  set(mobility_SOURCE_PREFIX "")
  set(mobility_DEVEL_PREFIX "")
  set(mobility_INSTALL_PREFIX /home/interamericana/rover_workspace/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mobility' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/interamericana/rover_workspace/src/mobility/${idir}'.  Ask the maintainer 'NASA Swarmathon <swarmathon@cs.unm.edu>' to fix it.")
    endif()
